...
Task Status: R4-401 is `LOCAL_VALIDATED / CI_PENDING`. The owner explicitly approved Vultr Tokyo (`nrt`) as the target platform and Japan/Tokyo as the data-residency boundary on 2026-08-25. Frozen contract digest `7018f0a06e334d86a7caf5e0ea142275370a7af10cb2c9a7bf448724c43ce2aa`, 11 directed mutation tests, full local regression, 34 Playwright scenarios with two expected skips, and focused resilience pass. No Vultr resource, credential, spend, or production deployment is authorized or claimed.

Next: complete R4-401 contract validation, commit/push, observe real GitHub Actions, close only after all five jobs pass, then recompute dependencies. R4-405 and R4-406 will become eligible after closure but may require Vultr credentials for external evidence. R4-410 and R4-422 retain separate human/external gates; R4-437 remains conditionally inactive. Keep `.codex-tmp/` untouched and untracked.

R3-365 closure report remains `docs/research/r3/ROUND_3_SCIENTIFIC_CLOSURE_REPORT.md`, byte SHA-256 `f5e12a289ccd7cd01c37edad739b4e4ace8496c80fd1dc82cc055d172a769632`. The active `docs/research/ROUND_4_TASK_GRAPH.yaml`, byte SHA-256 `8cfc90fafab108ca2a09d3a9cadacb96a1cc4a344095a55544fe33cab1cb5e40`, has 38 tasks across six workstreams, 15 external gates, 12 human approvals, three conditional tasks, 11 closure classifications, and 11 preserved Round 3 reclassification lanes. `scripts/round4_graph_gate.py` plus nine directed tests validate the live `TASK_GRAPH.yaml` mirror, reject gate/dependency/classification drift or claim promotion, and bind R3-325 plus the zero-`C-PASS` Claim Matrix. R3-313 maps to optional R4-437; R3-355 maps to R4-438/R4-439 and conditional R4-440. R4-401 read only the public Vultr catalog; no credentialed call, resource creation, production action, experiment, or R3-325 rerun occurred.
