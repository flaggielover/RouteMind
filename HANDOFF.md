...
Task Status: R4-405 is `LOCAL_VALIDATED / CI_PENDING / TARGET_PENDING`. Its five-boundary W3C correlation, tenant pseudonym/cardinality controls, logical volume attribution, bounded exporter/collector contract, and failure semantics pass all local gates. No target collector/backend/cost evidence exists. R4-406 remains blocked at its separate Vultr Tokyo target-evidence gate and is not closed.

Next: commit/push R4-405 and observe every real Actions job. Diagnose and repair CI regressions autonomously. Even after green CI, do not close R4-405 without credentialed Vultr `nrt` collector identity, five-boundary continuity, leakage/saturation/outage evidence, and backend usage/cost reconciliation. Recompute the graph after CI. R4-406 still needs Vultr credentials plus explicit resource/spend authorization before its target drill. Keep `.codex-tmp/` untouched and untracked.

R4-405 local evidence: contract digest `767ae48b9c377d0718eb28d16fe5539302d2dfc46f66f03e7ca71506fb502395`; collector digest `b7af884b5f6ad247157dac45da4df448af09e7acbc6ddcb7a758a159404a1b9e`; eight contract mutation tests; Java 113/113; Python 925/925 at 95.09%; Web 104/104 plus production build; serial resilience 16 Java / 2 Python. The candidate collector is configuration only. No credentialed call, resource creation, spend, running collector, production telemetry, currency cost, experiment, or R3-325 rerun occurred.

R3-365 closure report remains `docs/research/r3/ROUND_3_SCIENTIFIC_CLOSURE_REPORT.md`, byte SHA-256 `f5e12a289ccd7cd01c37edad739b4e4ace8496c80fd1dc82cc055d172a769632`. The active `docs/research/ROUND_4_TASK_GRAPH.yaml`, byte SHA-256 `1bb356e78c4ea3fc24d3db069c74dfcbc76c459c071a631a6deb4ca038dc9ef2`, has 38 tasks across six workstreams, 15 external gates, 12 human approvals, three conditional tasks, 11 closure classifications, and 11 preserved Round 3 reclassification lanes. `scripts/round4_graph_gate.py` plus nine directed tests validate the live `TASK_GRAPH.yaml` mirror, reject gate/dependency/classification drift or claim promotion, and bind R3-325 plus the zero-`C-PASS` Claim Matrix. R3-313 maps to optional R4-437; R3-355 maps to R4-438/R4-439 and conditional R4-440. R4-401 read only the public Vultr catalog; no credentialed call, resource creation, production action, experiment, or R3-325 rerun occurred.
