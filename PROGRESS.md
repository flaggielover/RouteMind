...
Current Gate: R4-404 is active. Role- and tenant-aware edge controls, automated secret/SBOM/provenance evidence, and a tested local WAF-equivalent policy are pending; no vendor deployment is claimed.
...
- Status: R4-403 passed real CI; R4-404 is `in_progress`.
- Completed gate: canonical tenant identity now scopes Java transactions, queries,
...
- CI: R4-403 implementation `534b9ef` passed all five jobs in run
  `32814670130`.
...
- Next: implement R4-404 role- and tenant-aware rate/abuse controls, automated
  secret/SBOM/provenance evidence, and a tested local WAF-equivalent policy.
