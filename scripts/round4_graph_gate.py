...
EXPECTED_REPLACEMENT_PROVIDER_GATE = {
    ...
    "evidence": [
        ...
        "evidence/gates/R4-411B/2026-08-28-google-live-validation-preflight.md",
    ...
    "execution_outcome": {
        "overall": "PARTIAL",
        "compute_routes": "PASS",
        "compute_route_matrix": "PARTIAL",
        "point_requests": 3,
        "matrix_requests": 1,
        "matrix_elements": 4,
        "elapsed_seconds": 2.433,
        "observed_external_cost_usd": "NOT_AVAILABLE_WITHOUT_BILLING_READBACK",
        "conservative_cost_upper_bound_usd": 1.0,
        "japan_matrix": "OBSERVED_PROVIDER_RESULT_ONLY; NO_ENTITLEMENT_CLAIM",
        "fallback_used": False,
    },
    "notes": "Approved bounded live validation completed with ComputeRoutes PASS and a partial ComputeRouteMatrix response (one of four cells returned ROUTE_EXISTS error). Provider-live validation is not claimed; no production, Tokyo-pinned processing, or Japan Matrix entitlement claim. Historical HERE R4-411 contracts and evidence remain preserved; Round 4 denominator is unchanged.",
}
