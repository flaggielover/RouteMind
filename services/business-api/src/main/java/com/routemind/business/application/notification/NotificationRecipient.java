...
public final class NotificationRecipient {
	...
	public NotificationRecipient(String address) {
	...
	/** Only the provider adapter may cross this boundary. Never log the returned value. */
	...
	public String toString() {
		return "NotificationRecipient{digest=" + digest().substring(0, 16) + "}";
	}

	@Override
	public boolean equals(Object other) {
		return other instanceof NotificationRecipient recipient && address.equals(recipient.address);
	}
