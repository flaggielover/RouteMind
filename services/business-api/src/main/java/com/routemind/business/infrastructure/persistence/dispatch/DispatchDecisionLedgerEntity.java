...
class DispatchDecisionLedgerEntity {
    ...
    static DispatchDecisionLedgerEntity from(DispatchDecisionLedger ledger) {
    ...
    DispatchDecisionLedger toDomain() {
        return new DispatchDecisionLedger(decisionId, requestId, idempotencyKey, orderId, courierId, strategy,
