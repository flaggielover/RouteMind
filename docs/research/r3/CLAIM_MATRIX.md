...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| R3-A1 | H1-A1: scoped Solomon verified-feasibility rate >= 0.95 lower bound | R3-357 pending; benchmark sources verified in R3-310 | Solomon C1/C2/R1/R2/RC1/RC2 lexicographic-first subset | `r3-311-solomon-stratified-six-v1` | 4/6 verified complete; Wilson 95% `[0.29999, 0.90323]` | Frozen lower bound >= 0.95 failed; all six retained | All incumbents passed R3-314; exact cross-check R3-315 and reproduction R3-356 pending | E-PASS / X-PASS / S-FAIL / C-NO-CLAIM | Bounded pilot produced 4 verified complete incumbents; no scoped feasibility, optimality, superiority, or external-validity claim |
