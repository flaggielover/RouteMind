...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| R3-A1 | H1-A1: scoped Solomon verified-feasibility rate >= 0.95 lower bound | R3-357 pending; benchmark sources verified in R3-310 | Solomon C1/C2/R1/R2/RC1/RC2 lexicographic-first subset | `r3-311-solomon-stratified-six-v1` | Verified feasible completion; 95% Wilson interval | Lower bound >= 0.95; all instances retained; maximum possible lower bound at n=6 is 0.6096657 | Independent verifier R3-314; exact cross-check R3-315 and reproduction R3-356 pending | E-IN-PROGRESS / X-IN-PROGRESS / S-FAIL-PRECOMMITTED / C-NO-CLAIM-PRECOMMITTED | No scoped feasibility claim; descriptive pilot only |
